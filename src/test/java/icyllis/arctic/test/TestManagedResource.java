...
package icyllis.arctic.test;

import icyllis.arctic.core.MathUtil;
import icyllis.arctic.core.*;
import icyllis.arctic.engine.*;
import icyllis.arctic.engine.geom.CircleGeometryProcessor;
import icyllis.arctic.opengl.*;
...
public class TestManagedResource {
    ...
    public static void main(String[] args) {
        ...
        GLPipelineState pipelineState = pipelineStateCache.findOrCreatePipelineState(server,
                new ProgramInfo(server.getCaps(),

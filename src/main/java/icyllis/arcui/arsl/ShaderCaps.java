...
public class ShaderCaps {
    ...
    // Used by ArSL to know when to generate polyfills.
    ...
    // If false, ArSL uses a workaround so that sk_FragCoord doesn't actually query gl_FragCoord
    ...
    // required by the spec. ArSL will always emit full ints.
    ...
    // This controls behavior of the ArSL compiler, not the code we generate. By default, ArSL pools

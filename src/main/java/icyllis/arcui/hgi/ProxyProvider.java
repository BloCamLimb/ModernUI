...
/**
 * A factory for creating {@link SurfaceProxy}-derived objects.
 */
public final class ProxyProvider {
    ...
    /**
     * Create a render target proxy that wraps a backend texture and is both texture-able and renderable.
     * <p>

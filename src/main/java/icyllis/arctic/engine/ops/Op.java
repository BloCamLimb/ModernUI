...
package icyllis.arctic.engine.ops;

import icyllis.arctic.core.RectF;
...
/**
 * Op is the base class for all Arctic deferred GPU operations. To facilitate reordering and to
 * minimize draw calls, Arctic does not generate geometry inline with draw calls. Instead, it

...
import icyllis.arctic.core.ImageInfo;
import icyllis.arctic.core.ImageInfo.ColorType;
import icyllis.arctic.text.TextBlobCache;
...
public abstract sealed class RecordingContext extends Context permits DeferredContext, DirectContext {
    ...
    /**
     * Can a {@link icyllis.arctic.core.Image} be created with the given color type.
     */
    ...
    /**
     * Can a {@link icyllis.arctic.core.Surface} be created with the given color type.

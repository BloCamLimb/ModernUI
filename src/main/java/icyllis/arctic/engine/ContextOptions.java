...
public final class ContextOptions {
    ...
    /**
     * Specifies the number of samples Arctic should use when performing internal draws with MSAA
     * (hardware capabilities permitting).
     * <p>
     * If 0, Arctic will disable internal code paths that use multisampling.
     */
    ...
    /**
     * In Arctic vulkan backend a single Context submit equates to the submission of a single

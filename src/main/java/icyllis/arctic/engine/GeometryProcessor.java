...
import icyllis.arctic.engine.shading.*;
...
import static icyllis.arctic.engine.shading.ProgramDataManager.UniformHandle;
import static icyllis.arctic.engine.shading.UniformHandler.SamplerHandle;
 ...
 * responsible for providing a color and coverage input into the Arctic rendering pipeline. Through
 * optimization, Arctic may decide a different color, no color, and / or no coverage are required

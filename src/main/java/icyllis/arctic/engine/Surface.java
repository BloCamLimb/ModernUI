 ...
 * {@link icyllis.arctic.core.Surface} or {@link org.lwjgl.vulkan.KHRSurface},
 */
public abstract class Surface extends GpuResource {
     ...
     * Don't confuse this with {@link icyllis.arctic.core.Surface} or
     * {@link icyllis.arctic.core.SurfaceCharacterization}, core package surfaces are render targets.
     * <p>
     * <h3>For OpenGL</h3>
     * <ul>
     *     <code>isProtected</code> must be false.
     *     <li><code>sampleCount</code> is 1, it's {@link icyllis.arctic.opengl.GLTexture},
     *     used as textures and can be promoted to render targets (managed by {@link Server}).</li>
     *     <li><code>sampleCount</code> is > 1, it's {@link icyllis.arctic.opengl.GLRenderbuffer}
     ...
     * <h3>For Vulkan</h3>
     * <ul>
     *     <li><code>sampleCount</code> is 1, it's {@link icyllis.arctic.vulkan.VkImage},
     *     used as textures and can be promoted to render targets (managed by {@link Server}).</li>
     *     <li><code>sampleCount</code> is > 1, it's {@link icyllis.arctic.vulkan.VkImage},
     *     and can be stencil attachments or MSAA color attachments of render targets,
     *     <code>mipmapped</code> must be false.</li>

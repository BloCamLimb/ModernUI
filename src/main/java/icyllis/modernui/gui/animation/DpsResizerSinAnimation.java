...
public class DpsResizerSinAnimation implements IAnimation {
    ...
    public DpsResizerSinAnimation(float duration, boolean isVertical, Consumer<Float> receiver, Consumer<Function<Integer, Float>> resizerReceiver) {
    ...
    public DpsResizerSinAnimation init(Function<Integer, Float> initResizer, Function<Integer, Float> targetResizer) {
    ...
    public DpsResizerSinAnimation withDelay(float time) {
        startTime = startTime + time;
        return this;
    }

    public DpsResizerSinAnimation onFinish(Runnable r) {
        onFinish = r;
        return this;
    }
    ...
    public void update(float currentTime) {
        ...
        this.value = initValue + (targetValue - initValue) * sin;
        if (p >= 1) {

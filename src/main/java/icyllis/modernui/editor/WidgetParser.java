...
package icyllis.modernui.editor;

import com.google.gson.*;
import com.google.gson.reflect.TypeToken;
import icyllis.modernui.editor.adaptor.WidgetAdaptor;
...
public enum WidgetParser {
    ...
    public List<WidgetContainer> parseWidgets(ResourceLocation location) {
        ...
        try (BufferedReader br =
            ...
            ModernUI.LOGGER.fatal(GlobalModuleManager.MARKER, "Failed to parse widget json at {}", location);
            e.printStackTrace();
        }

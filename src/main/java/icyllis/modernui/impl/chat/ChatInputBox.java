...
public final class ChatInputBox extends StandardEventListener {
    ...
    public void draw() {
        if(isDoubleLined) {
            ...
            renderer.drawString(text.substring(0, firstLength), x, y - 10.5f, Color3i.GRAY_224, 1.0f, Align3H.LEFT);
            renderer.drawString(text.substring(firstLength), x, y + 1.5f, Color3i.GRAY_224, 1.0f, Align3H.LEFT);
        } else {
            ...
            renderer.drawString(text, x, y + 1.5f, Color3i.GRAY_224, 1.0f, Align3H.LEFT);
        }

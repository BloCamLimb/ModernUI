...
import icyllis.modernui.system.MixinMethods;
...
public class MixinMainWindow {
    ...
    /**
     * @author BloCamLimb
     * @reason Make GUI scale suitable, and not limited to even numbers when forceUnicode = true
     */
    @Overwrite
    public int calcGuiScale(int guiScaleIn, boolean forceUnicode) {
        int r = MixinMethods.calcGuiScales((MainWindow) (Object) this);

...
public class TrueTypeRenderer implements IFontRenderer {
     ...
     * Config values
     *
     * @see icyllis.modernui.system.ModernUI_Font.Config
     */
     ...
     */
    private final TextCacheProcessor cache = new TextCacheProcessor();
    ...
    public float drawString(@Nullable String str, float startX, float startY, int r, int g, int b, int a, TextAlign align) {
        ...
        int fontStyle = TextCacheProcessor.FormattingCode.PLAIN;

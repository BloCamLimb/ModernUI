...
import icyllis.modernui.mcimpl.TestUI;
...
final class EventHandler {
    ...
    static class Internal {
        ...
        static void onMenuOpen(@Nonnull OpenMenuEvent event) {
            if (event.getMenu().getType() == MuiModRegistries.TEST_MENU) {
    ...
    static class ModClient {
        ...
        static void onBakeModel(@Nonnull ModelBakeEvent event) {
            ...
            replaceModel(registry, new ModelResourceLocation(
                            Objects.requireNonNull(MuiModRegistries.PROJECT_BUILDER_ITEM.getRegistryName()), "inventory"),

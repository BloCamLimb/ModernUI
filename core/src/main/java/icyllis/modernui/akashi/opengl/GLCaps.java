...
public final class GLCaps extends Caps {
    ...
    public GLCaps(ContextOptions options, GLCapabilities caps) {
        ...
        mMaxFragmentUniformVectors = GL11C.glGetInteger(GL41C.GL_MAX_FRAGMENT_UNIFORM_VECTORS);
        mMaxVertexAttributes = Math.min(32, GL11C.glGetInteger(GL20C.GL_MAX_VERTEX_ATTRIBS));
        ...
        mMaxLabelLength = GL11C.glGetInteger(GL43C.GL_MAX_LABEL_LENGTH);
        ...
        shaderCaps.mMaxFragmentSamplers = Math.min(32, GL11C.glGetInteger(GL20C.GL_MAX_TEXTURE_IMAGE_UNITS));
        ...
        if (mAnisotropySupport) {
            mMaxTextureMaxAnisotropy = GL11C.glGetFloat(GL46C.GL_MAX_TEXTURE_MAX_ANISOTROPY);
        }

        mMaxTextureSize = GL11C.glGetInteger(GL11C.GL_MAX_TEXTURE_SIZE);
        mMaxRenderTargetSize = GL11C.glGetInteger(GL30C.GL_MAX_RENDERBUFFER_SIZE);
        ...
        int count = GL11C.glGetInteger(GL41C.GL_NUM_PROGRAM_BINARY_FORMATS);
        mProgramBinaryFormats = new int[count];
        if (count > 0) {
            GL11C.glGetIntegerv(GL41C.GL_PROGRAM_BINARY_FORMATS, mProgramBinaryFormats);
        }
    ...
    private void initGLSL(GLCapabilities caps) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            int bits = GL41C.glGetShaderPrecisionFormat(GL20C.GL_FRAGMENT_SHADER, GL41C.GL_MEDIUM_FLOAT, range);
            shaderCaps.mHalfIs32Bits &= range.get(0) >= 127 && range.get(1) >= 127 && bits >= 23;
            bits = GL41C.glGetShaderPrecisionFormat(GL20C.GL_VERTEX_SHADER, GL41C.GL_MEDIUM_FLOAT, range);
            shaderCaps.mHalfIs32Bits &= range.get(0) >= 127 && range.get(1) >= 127 && bits >= 23;
        }
    ...
    private void initFormatTable(GLCapabilities caps) {
        ...
        // Format: RGBA8
        {
            final int format = GL11C.GL_RGBA8;
            ...
            info.mDefaultExternalFormat = GL11C.GL_RGBA;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_BYTE;
            ...
            // Format: RGBA8, Surface: kRGBA_8888
            {
                ...
                // Format: RGBA8, Surface: kRGBA_8888, Data: kRGBA_8888
                {
                    ...
                    ioFormat.mExternalType = GL11C.GL_UNSIGNED_BYTE;
                    ioFormat.mExternalWriteFormat = GL11C.GL_RGBA;
                    ioFormat.mExternalReadFormat = GL11C.GL_RGBA;
                }
                ...
                // Format: RGBA8, Surface: kRGBA_8888, Data: kBGRA_8888
                {
                    ...
                    ioFormat.mExternalType = GL11C.GL_UNSIGNED_BYTE;
                    ioFormat.mExternalWriteFormat = GL12C.GL_BGRA;
                    ioFormat.mExternalReadFormat = GL12C.GL_BGRA;
                }
            }
        ...
        // Format: R8
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL30C.GL_R8;
            info.mDefaultExternalFormat = GL11C.GL_RED;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_BYTE;
            info.mDefaultColorType = ImageInfo.CT_R_8;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG | FormatInfo.TRANSFERS_FLAG;
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_R8;
            ...
            // Format: R8, Surface: kR_8
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_R_8, GL30C.GL_R8);
                ...
                // Format: R8, Surface: kR_8, Data: kR_8
                {
                    ...
                    ioFormat.mExternalType = GL11C.GL_UNSIGNED_BYTE;
                    ioFormat.mExternalWriteFormat = GL11C.GL_RED;
                    ioFormat.mExternalReadFormat = GL11C.GL_RED;
                }
            ...
            // Format: R8, Surface: kAlpha_8
            {
                ...
                setColorTypeFormat(ImageInfo.CT_ALPHA_8, GL30C.GL_R8);
            ...
            // Format: R8, Surface: kGray_8
            {
                ...
                setColorTypeFormat(ImageInfo.CT_GRAY_8, GL30C.GL_R8);
        ...
        // Format: RGB565
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL41C.GL_RGB565;
            info.mDefaultExternalFormat = GL11C.GL_RGB;
            info.mDefaultExternalType = GL12C.GL_UNSIGNED_SHORT_5_6_5;
            info.mDefaultColorType = ImageInfo.CT_RGB_565;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG | FormatInfo.TRANSFERS_FLAG;
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL41C.GL_RGB565;
            ...
            // Format: RGB565, Surface: kBGR_565
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGB_565, GL41C.GL_RGB565);
                ...
                // Format: RGB565, Surface: kBGR_565, Data: kBGR_565
                {
                    ...
                    ioFormat.mExternalType = GL12C.GL_UNSIGNED_SHORT_5_6_5;
                    ioFormat.mExternalWriteFormat = GL11C.GL_RGB;
                    ioFormat.mExternalReadFormat = GL11C.GL_RGB;
                }
        ...
        // Format: RGBA16F
        {
            ...
            info.mInternalFormatForRenderbuffer = GL30C.GL_RGBA16F;
            info.mDefaultExternalFormat = GL11C.GL_RGBA;
            info.mDefaultExternalType = GL30C.GL_HALF_FLOAT;
            info.mDefaultColorType = ImageInfo.CT_RGBA_F16;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG | FormatInfo.TRANSFERS_FLAG;
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_RGBA16F;
            ...
            // Format: RGBA16F, Surface: kRGBA_F16
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGBA_F16, GL30C.GL_RGBA16F);
                ...
                // Format: RGBA16F, Surface: kRGBA_F16, Data: kRGBA_F16
                {
                    ...
                    ioFormat.mExternalType = GL30C.GL_HALF_FLOAT;
                    ioFormat.mExternalWriteFormat = GL11C.GL_RGBA;
                    ioFormat.mExternalReadFormat = GL11C.GL_RGBA;
                }
                ...
                // Format: RGBA16F, Surface: kRGBA_F16, Data: kRGBA_F32
                {
                    ...
                    ioFormat.mExternalType = GL11C.GL_FLOAT;
                    ioFormat.mExternalWriteFormat = 0;
                    ioFormat.mExternalReadFormat = GL11C.GL_RGBA;
                }
            }
            ...
            // Format: RGBA16F, Surface: kRGBA_F16_Clamped
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGBA_F16_CLAMPED, GL30C.GL_RGBA16F);
        ...
        // Format: R16F
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_FLOAT;
            info.mInternalFormatForRenderbuffer = GL30C.GL_R16F;
            info.mDefaultExternalFormat = GL11C.GL_RED;
            info.mDefaultExternalType = GL30C.GL_HALF_FLOAT;
            ...
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_R16F;
            ...
            info.mColorTypeInfos = new ColorTypeInfo[1];
            {
                ...
                ctInfo.mReadSwizzle = Swizzle.make("000r");
                ctInfo.mWriteSwizzle = Swizzle.make("a000");
                setColorTypeFormat(ImageInfo.CT_ALPHA_F16, GL30C.GL_R16F);
        ...
        // Format: RGB8
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL11C.GL_RGB8;
            info.mDefaultExternalFormat = GL11C.GL_RGB;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_BYTE;
            ...
            if (GL42C.glGetInternalformati(GL30C.GL_RENDERBUFFER, GL11C.GL_RGB8, GL43C.GL_INTERNALFORMAT_SUPPORTED) == GL11C.GL_TRUE) {
                info.mFlags |= msaaRenderFlags;
            } else {
                info.mFlags |= nonMSAARenderFlags;
            }
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL11C.GL_RGB8;
            ...
            // Format: RGB8, Surface: kRGB_888x
            {
                ...
                ctInfo.mColorType = ImageInfo.CT_RGB_888x;
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGB_888x, GL11C.GL_RGB8);
        ...
        // Format: RG8
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL30C.GL_RG8;
            info.mDefaultExternalFormat = GL30C.GL_RG;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_BYTE;
            info.mDefaultColorType = ImageInfo.CT_RG_88;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG | FormatInfo.TRANSFERS_FLAG;
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_RG8;
            ...
            // Format: RG8, Surface: kRG_88
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RG_88, GL30C.GL_RG8);
                ...
                // Format: RG8, Surface: kRG_88, Data: kRG_88
                {
                    ...
                    ioFormat.mExternalType = GL11C.GL_UNSIGNED_BYTE;
                    ioFormat.mExternalWriteFormat = GL30C.GL_RG;
                    ioFormat.mExternalReadFormat = GL30C.GL_RG;
                }
        ...
        // Format: RGB10_A2
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL11C.GL_RGB10_A2;
            info.mDefaultExternalFormat = GL11C.GL_RGBA;
            info.mDefaultExternalType = GL12C.GL_UNSIGNED_INT_2_10_10_10_REV;
            info.mDefaultColorType = ImageInfo.CT_RGBA_1010102;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG | FormatInfo.TRANSFERS_FLAG;
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL11C.GL_RGB10_A2;
            ...
            // Format: RGB10_A2, Surface: kRGBA_1010102
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGBA_1010102, GL11C.GL_RGB10_A2);
                ...
                // Format: RGB10_A2, Surface: kRGBA_1010102, Data: kRGBA_1010102
                {
                    ...
                    ioFormat.mExternalType = GL12C.GL_UNSIGNED_INT_2_10_10_10_REV;
                    ioFormat.mExternalWriteFormat = GL11C.GL_RGBA;
                    ioFormat.mExternalReadFormat = GL11C.GL_RGBA;
                }
            ...
            // Format: RGB10_A2, Surface: kBGRA_1010102
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_BGRA_1010102, GL11C.GL_RGB10_A2);
        ...
        // Format: SRGB8_ALPHA8
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL21C.GL_SRGB8_ALPHA8;
            info.mDefaultExternalFormat = GL11C.GL_RGBA;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_BYTE;
            ...
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL21C.GL_SRGB8_ALPHA8;
            ...
            // Format: SRGB8_ALPHA8, Surface: kRGBA_8888_SRGB
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGBA_8888_SRGB, GL21C.GL_SRGB8_ALPHA8);
        ...
        // Format: COMPRESSED_RGB8_ETC2
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForTexture = GL43C.GL_COMPRESSED_RGB8_ETC2;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG;

            mCompressionTypeToBackendFormat[ImageInfo.COMPRESSION_ETC2_RGB8_UNORM] =
                    GLBackendFormat.make(GL43C.GL_COMPRESSED_RGB8_ETC2);
        ...
        // Format: R16
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL30C.GL_R16;
            info.mDefaultExternalFormat = GL11C.GL_RED;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_SHORT;
            info.mDefaultColorType = ImageInfo.CT_R_16;
            info.mFlags = FormatInfo.TEXTURABLE_FLAG | FormatInfo.TRANSFERS_FLAG;
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_R16;
            ...
            // Format: R16, Surface: kAlpha_16
            {
                ...
                ctInfo.mReadSwizzle = Swizzle.make("000r");
                ctInfo.mWriteSwizzle = Swizzle.make("a000");
                setColorTypeFormat(ImageInfo.CT_ALPHA_16, GL30C.GL_R16);
                ...
                // Format: R16, Surface: kAlpha_16, Data: kAlpha_16
                {
                    ...
                    ioFormat.mExternalType = GL11C.GL_UNSIGNED_SHORT;
                    ioFormat.mExternalWriteFormat = GL11C.GL_RED;
                    ioFormat.mExternalReadFormat = GL11C.GL_RED;
                }
        ...
        // Format: RG16
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL30C.GL_RG16;
            info.mDefaultExternalFormat = GL30C.GL_RG;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_SHORT;
            ...
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_RG16;
            ...
            // Format: GL_RG16, Surface: kRG_1616
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RG_1616, GL30C.GL_RG16);
        ...
        // Format: RGBA16
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_NORMALIZED_FIXED_POINT;
            info.mInternalFormatForRenderbuffer = GL11C.GL_RGBA16;
            info.mDefaultExternalFormat = GL11C.GL_RGBA;
            info.mDefaultExternalType = GL11C.GL_UNSIGNED_SHORT;
            ...
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL11C.GL_RGBA16;
            ...
            info.mColorTypeInfos = new ColorTypeInfo[1];
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RGBA_16161616, GL11C.GL_RGBA16);
        ...
        // Format:RG16F
        {
            ...
            info.mFormatType = FormatInfo.FORMAT_TYPE_FLOAT;
            info.mInternalFormatForRenderbuffer = GL30C.GL_RG16F;
            info.mDefaultExternalFormat = GL30C.GL_RG;
            info.mDefaultExternalType = GL30C.GL_HALF_FLOAT;
            ...
            info.mFlags |= msaaRenderFlags;
            info.mFlags |= FormatInfo.TEXTURE_STORAGE_FLAG;
            info.mInternalFormatForTexture = GL30C.GL_RG16F;
            ...
            // Format: GL_RG16F, Surface: kRG_F16
            {
                ...
                ctInfo.mFlags = ColorTypeInfo.UPLOAD_DATA_FLAG | ColorTypeInfo.RENDERABLE_FLAG;
                setColorTypeFormat(ImageInfo.CT_RG_F16, GL30C.GL_RG16F);
    ...
    public static int getExternalTypeAlignment(int type) {
        ...
        return switch (type) {
            case GL11C.GL_UNSIGNED_BYTE,
                    GL11C.GL_BYTE,
                    GL12C.GL_UNSIGNED_BYTE_2_3_3_REV,
                    GL12C.GL_UNSIGNED_BYTE_3_3_2 -> 1;
            case GL11C.GL_UNSIGNED_SHORT,
                    GL11C.GL_SHORT,
                    GL12C.GL_UNSIGNED_SHORT_1_5_5_5_REV,
                    GL12C.GL_UNSIGNED_SHORT_4_4_4_4_REV,
                    GL12C.GL_UNSIGNED_SHORT_5_6_5_REV,
                    GL12C.GL_UNSIGNED_SHORT_5_5_5_1,
                    GL12C.GL_UNSIGNED_SHORT_4_4_4_4,
                    GL12C.GL_UNSIGNED_SHORT_5_6_5,
                    GL30C.GL_HALF_FLOAT -> 2;
            case GL11C.GL_UNSIGNED_INT,
                    GL30C.GL_FLOAT_32_UNSIGNED_INT_24_8_REV,
                    GL30C.GL_UNSIGNED_INT_5_9_9_9_REV,
                    GL30C.GL_UNSIGNED_INT_10F_11F_11F_REV,
                    GL30C.GL_UNSIGNED_INT_24_8,
                    GL12C.GL_UNSIGNED_INT_10_10_10_2,
                    GL12C.GL_UNSIGNED_INT_8_8_8_8_REV,
                    GL12C.GL_UNSIGNED_INT_8_8_8_8,
                    GL12C.GL_UNSIGNED_INT_2_10_10_10_REV,
                    GL11C.GL_FLOAT,
                    GL11C.GL_INT -> 4;
            default -> 0;
        };

 ...
 * read the <a href="https://developer.android.com/guide/topics/ui/menus.html#context-menu">Menus</a>
 * developer guide.</p>
 * </div>
 */
public abstract class ActionMode {
     ...
     *
     * @see Callback#onGetContentRect(ActionMode, View, Rect) .
     */
    ...
    public interface Callback {
         ...
         * {@link ActionMode#TYPE_FLOATING} to ensure the positioning doesn't obscure app content.

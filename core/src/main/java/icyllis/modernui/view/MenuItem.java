...
public interface MenuItem {
     ...
     *
     * @return The condensed title, if it exists. The normal title otherwise.
     */
     ...
     * loaded before). Note that if you call {@link #setIconTintList(ColorStateList)}
     * on this item, and you use a custom menu presenter in your application,
     * you have to apply the tinting explicitly on the {@link Drawable} returned by this method.
     *
     ...
     * <p>
     * Subsequent calls to {@link #setIcon(Drawable)} will
     ...
     * set via {@link #setActionView(View)}.
     * </p>
     *

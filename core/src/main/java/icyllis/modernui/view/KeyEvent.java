...
public class KeyEvent extends InputEvent {
    ...
    public static final int META_CONTROL_ON = GLFW.GLFW_MOD_CONTROL;
     ...
     * On macOS, this is {@link #META_SUPER_ON} key; otherwise, this is {@link #META_CONTROL_ON} key.
     */
    public static final int META_SHORTCUT_ON = IS_MACOS ? META_SUPER_ON : META_CONTROL_ON;
    /**
     * This is same as {@link #META_SHORTCUT_ON}, if you want exact CONTROL
     * key, use {@link #META_CONTROL_ON} instead.
     * @deprecated use {@link #META_SHORTCUT_ON} to avoid confusion
     */
    @Deprecated
    public static final int META_CTRL_ON = META_SHORTCUT_ON;
    ...
    public final boolean isControlPressed() {
        return (mModifiers & META_CONTROL_ON) != 0;
    }
    ...
    public final boolean isShortcutPressed() {
        return (mModifiers & META_SHORTCUT_ON) != 0;
    }

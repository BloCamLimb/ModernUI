...
public class RadialGradient extends GradientShader {
    ...
    private RadialGradient(float centerX, float centerY,
        ...
        var shader = icyllis.arc3d.sketch.shaders.RadialGradient.make(
                centerX, centerY,
                radius,
                colors,
    ...
    private RadialGradient(@NonNull icyllis.arc3d.sketch.shaders.Shader newShader,
    ...
    /**
     * Create a new RadialGradient that replaces its local matrix with a new local matrix.
     ...
     */
    @NonNull
    public RadialGradient copyWithLocalMatrix(@Nullable Matrix newLocalMatrix) {
        var shader = mShader;
        if (shader == null) {
            throw new IllegalStateException("RadialGradient is already released");
        }
        ...
        return new RadialGradient(newShader, newLocalMatrix);
    }

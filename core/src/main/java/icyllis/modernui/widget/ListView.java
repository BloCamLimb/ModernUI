...
public class ListView extends AbsListView {
    ...
    private void correctTooHigh(int childCount) {
        ...
        if (lastPosition == mItemCount - 1 && childCount > 0) {
            ...
            final int end = getHeight() - mListPadding.bottom;
    ...
    protected void layoutChildren() {
        ...
        try {
            ...
            // our view hierarchy.
            if (focusLayoutRestoreView != null
                    && focusLayoutRestoreView.isAttachedToWindow()) {
    ...
    private boolean commonKey(int keyCode, KeyEvent event) {
        ...
        if ((keyCode == KeyEvent.KEY_ENTER || keyCode == KeyEvent.KEY_KP_ENTER)
            ...
            if (!handled && !event.isRepeat() && getChildCount() > 0) {
                keyPressed();
                handled = true;
            }
        }
     ...
     */
    private int nextSelectedPositionForDirection(
    ...
    protected void dispatchDraw(@NonNull Canvas canvas) {
        ...
        if (drawDividers || drawOverscrollHeader || drawOverscrollFooter) {
            ...
            bounds.right = getWidth() - mPaddingRight;
            ...
            if ((headerDividers || !isHeader) && (footerDividers || !isFooter)) {
                ...
                if (!mStackFromBottom) {
                    ...
                    if (!drawOverscrollFooter || !isLastItem) {
                        ...
                        // and/or footers when enabled and requested, and
                        // after the last enabled item.
                        return adapter.isEnabled(itemIndex) &&

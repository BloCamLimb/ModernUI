...
public class ExpandableListView extends ListView {
    ...
    private static final long PACKED_POSITION_INT_MASK_CHILD = 0x00000000FFFFFFFFL;

    /** The mask (in integer group position representation) for the group */
    private static final long PACKED_POSITION_INT_MASK_GROUP = 0x000000007FFFFFFFL;
     ...
     *            {@link R.attr#state_last} will be set.
     */
     ...
     *            group is empty, the state {@link R.attr#state_empty} will be
     *            set. If the group is expanded, the state
     *            {@link R.attr#state_expanded} will be set.
     */

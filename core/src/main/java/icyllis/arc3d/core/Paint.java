...
public class Paint {
     ...
     */
    public final void setStyle(@Paint.Style int style) {
     ...
     */
    public final void setStrokeCap(@Paint.Cap int cap) {
     ...
     */
    public final void setStrokeJoin(@Paint.Join int join) {
     ...
     */
    public final void setStrokeAlign(@Paint.Align int align) {
     ...
     * @see #getFilterMode()
     */
    public final void setFilterMode(@Paint.FilterMode int filter) {
     ...
     */
    public final void setMipmapMode(@Paint.MipmapMode int mipmap) {

 ...
 */
public non-sealed class KeyBuilder implements Key {
    ...
    public final Key toKey() {
        assert (mCurValue == 0 && mBitsUsed == 0);
        return new Storage(mData.toIntArray());
    }
    ...
    public final boolean equals(Object o) {
        ...
        return o instanceof Storage key && // check for null
                Arrays.equals(mData.elements(), 0, mData.size(), key.data, 0, key.data.length);
    }
